...
fn block_sizes_match_c_layout() {
    use crate::format::{
        block_bytes, block_size, IQ2_XXS_BLOCK, Q2_K_BLOCK, Q3_K_BLOCK, Q4_K_BLOCK, Q8_0_BLOCK,
    };
    assert_eq!(block_size(QuantKind::Q8_0), Q8_0_BLOCK);
    assert_eq!(block_size(QuantKind::Q4_K), Q4_K_BLOCK);
    assert_eq!(block_size(QuantKind::Q3_K), Q3_K_BLOCK);
    ...
    assert_eq!(block_bytes(QuantKind::Q3_K), 32 + 64 + 12 + 2);
